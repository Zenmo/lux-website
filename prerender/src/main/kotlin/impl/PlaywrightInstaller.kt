package energy.lux.prerender.impl
 ...
 * https://github.com/varabyte/kobweb/blob/38a035a5a18f602179ebc36712b6ea351fae378d/tools/gradle-plugins/application/src/main/kotlin/com/varabyte/kobweb/gradle/application/util/PlaywrightCache.kt
 *
 ...
 */
internal class PlaywrightInstaller {
    /**
    ...
    fun install() {
        ...
        pb.command().addAll(listOf("install", "firefox"))
