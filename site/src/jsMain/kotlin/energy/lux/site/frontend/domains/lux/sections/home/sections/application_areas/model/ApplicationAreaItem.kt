package energy.lux.site.frontend.domains.lux.sections.home.sections.application_areas.model
    ...
    companion object {
        val luxApplicationAreas = listOf(
            ApplicationAreaItem(
                ...
                icon = { MdiApartment(Modifier.Companion.featureIcon(size = 32.px)) }
            ),
            ApplicationAreaItem(
                ...
                icon = { MdiLan(Modifier.Companion.featureIcon(size = 32.px)) }
            ),
            ApplicationAreaItem(
                ...
                icon = { MdiHouse(Modifier.Companion.featureIcon(size = 32.px)) }
            ),
            ApplicationAreaItem(
                ...
                icon = { MdiBolt(Modifier.Companion.featureIcon(size = 32.px)) }
            ),
        )
    }
}