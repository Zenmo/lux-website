...
fun PapendrechtPage() {
    DrechtstedenTwinLayout(
        title = papendrechtOosteind.label.nl,
        useTwinPageHeader = true,
        enTwinPageHeaderTitle = papendrechtOosteind.label.en,
        nlTwinPageHeaderTitle = papendrechtOosteind.label.nl,
    ) {
        ModelInDevelopmentInfoWidget()
        ModelPageContent(
            modelLabel = papendrechtOosteind.label,
            ...
            pageImageSrc = papendrechtOosteind.imageUrl
        ) {
            ProfileContactCard(
