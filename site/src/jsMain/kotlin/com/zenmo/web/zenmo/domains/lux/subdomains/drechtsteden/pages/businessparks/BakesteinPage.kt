...
fun BakesteinPage() {
    DrechtstedenTwinLayout(
        title = bakestein.label.nl,
        useTwinPageHeader = true,
        enTwinPageHeaderTitle = bakestein.label.en,
        nlTwinPageHeaderTitle = bakestein.label.nl,
    ) {
        ...
        ModelPageContent(
            ...
            pageImageSrc = bakestein.imageUrl
        ) {
            ProfileContactCard(
