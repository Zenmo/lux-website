...
fun AmbachtsePage() {
    DrechtstedenTwinLayout(
        title = ambachtseZoom.label.nl,
        useTwinPageHeader = true,
        enTwinPageHeaderTitle = ambachtseZoom.label.en,
        nlTwinPageHeaderTitle = ambachtseZoom.label.nl,
    ) {
        ModelInDevelopmentInfoWidget()
        ModelPageContent(
            modelLabel = ambachtseZoom.label,
            ...
            """.trimIndent(),
            pageImageSrc = ambachtseZoom.imageUrl
        ) {
            ProfileContactCard(
