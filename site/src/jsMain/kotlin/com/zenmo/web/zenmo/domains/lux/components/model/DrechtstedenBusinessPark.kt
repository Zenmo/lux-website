...
sealed class DrechtstedenBusinessPark(
    ...
    data object AmbachtseZoom : DrechtstedenBusinessPark(
        "ambachtsezoom",
    ...
    data object AmstelwijckBusinesspark : DrechtstedenBusinessPark(
    ...
    data object Antoniapolder : DrechtstedenBusinessPark(
        "antoniapolder",
    ...
    data object Bakestein : DrechtstedenBusinessPark(
        "bakestein",
    ...
    data object DeGeer : DrechtstedenBusinessPark(
        "degeer",
    ...
    data object DeStaart : DrechtstedenBusinessPark(
        "destaart",
    ...
    data object DordtseKil12AmstelwijckWest : DrechtstedenBusinessPark(
    ...
    data object DordtseKil34 : DrechtstedenBusinessPark(
        "dordtsekil34",
    ...
    data object GrooteLindtV2 : DrechtstedenBusinessPark(
        "grootelindtv2",
    ...
    data object Leerpark : DrechtstedenBusinessPark(
        "leerpark",
    ...
    data object NieuweWeg : DrechtstedenBusinessPark(
        "nieuweweg",
    ...
    data object PapendrechtOosteind : DrechtstedenBusinessPark(
        "papendrechtoosteind",
    ...
    data object SliedrechtBusinesspark : DrechtstedenBusinessPark(
