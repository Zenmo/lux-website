...
fun GemeenteAlblasserdamPage() {
    DrechtstedenTwinLayout(
        title = alblasserdam.label.nl,
        useTwinPageHeader = true,
        enTwinPageHeaderTitle = alblasserdam.label.en,
        nlTwinPageHeaderTitle = alblasserdam.label.nl,
    ) {
        ModelInDevelopmentInfoWidget()
        ModelPageContent(
            modelLabel = alblasserdam.label,
            ...
            """.trimIndent(),
            pageImageSrc = alblasserdam.imageUrl
        ) {
            ProfileContactCard(
