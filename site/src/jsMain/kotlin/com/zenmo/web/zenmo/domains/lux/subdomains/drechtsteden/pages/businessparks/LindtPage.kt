...
fun LindtPage() {
    DrechtstedenTwinLayout(
        title = grooteLindtV2.label.nl,
        useTwinPageHeader = true,
        enTwinPageHeaderTitle = grooteLindtV2.label.en,
        nlTwinPageHeaderTitle = grooteLindtV2.label.nl,
    ) {
        ModelInDevelopmentInfoWidget()
        ModelPageContent(
            modelLabel = grooteLindtV2.label,
            ...
            pageImageSrc = grooteLindtV2.imageUrl
        ) {
            ProfileContactCard(
